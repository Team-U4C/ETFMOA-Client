...
import r$2, {useContext, useRef, useLayoutEffect, createElement, useEffect, useState} from "react";
 ...
 */
var b$2 = 60103, c$1 = 60106, d$1 = 60107, e$1 = 60108, f$2 = 60114, g$3 = 60109, h$2 = 60110, k$2 = 60112, l$1 = 60113, m$2 = 60120, n$2 = 60115, p$2 = 60116, q$3 = 60121, r$1 = 60122, u = 60117, v$2 = 60129, w$2 = 60131;
...
var z$2 = g$3, A$2 = b$2, B$1 = k$2, C = d$1, D = p$2, E$1 = n$2, F$1 = c$1, G$1 = f$2, H$1 = e$1, I$1 = l$1;
...
reactIs_production_min$1.isValidElementType = function(a) {
  return typeof a === "string" || typeof a === "function" || a === d$1 || a === f$2 || a === v$2 || a === e$1 || a === l$1 || a === m$2 || a === w$2 || typeof a === "object" && a !== null && (a.$$typeof === p$2 || a.$$typeof === n$2 || a.$$typeof === g$3 || a.$$typeof === h$2 || a.$$typeof === k$2 || a.$$typeof === u || a.$$typeof === q$3 || a[0] === r$1) ? true : false;
};
...
function stylis_min(W2) {
  function M2(d2, c2, e2, h, a) {
    for(var m2 = 0, b2 = 0, v2 = 0, n2 = 0, q2, g2, x2 = 0, K2 = 0, k2, u2 = k2 = q2 = 0, l2 = 0, r2 = 0, I2 = 0, t2 = 0, B3 = e2.length, J2 = B3 - 1, y2, f2 = "", p2 = "", F3 = "", G3 = "", C2; l2 < B3;) {
      ...
      if(b2 + n2 + v2 + m2 === 0) {
        ...
        switch(g2) {
          case 123:
            ...
            switch(q2) {
              case 64:
                ...
                t2 = k2.length;
                0 < A2 && (r2 = X2(O2, f2, I2), C2 = H2(3, k2, r2, c2, D2, z2, t2, g2, a, h), f2 = r2.join(""), C2 !== void 0 && (t2 = (k2 = C2.trim()).length) === 0 && (g2 = 0, k2 = ""));
                if(0 < t2)
                  switch(g2) {
                    case 115:
                      f2 = f2.replace(da, ea);
          ...
          case 59:
            ...
            if(1 < (t2 = f2.length))
              switch(u2 === 0 && (q2 = f2.charCodeAt(0), q2 === 45 || 96 < q2 && 123 > q2) && (t2 = (f2 = f2.replace(" ", ":")).length), 0 < A2 && (C2 = H2(1, f2, c2, d2, D2, z2, p2.length, h, a, h)) !== void 0 && (t2 = (f2 = C2.trim()).length) === 0 && (f2 = "\0\0"), q2 = f2.charCodeAt(0), g2 = f2.charCodeAt(1), q2) {
                case 0:
                  break;
                case 64:
                  if(g2 === 105 || g2 === 99) {
      ...
      switch(g2) {
        ...
        case 10:
          ...
          0 < A2 * Y2 && H2(0, f2, c2, d2, D2, z2, p2.length, h, a, h);
          z2 = 1;
          D2++;
          break;
        case 59:
    ...
    if(0 < t2) {
      r2 = c2;
      if(0 < A2 && (C2 = H2(2, p2, r2, d2, D2, z2, t2, h, a, h), C2 !== void 0 && (p2 = C2).length === 0))
        return G3 + p2 + F3;
      p2 = r2.join(",") + "{" + p2 + "}";
      if(w2 * E2 !== 0) {
        w2 !== 2 || L2(p2, 2) || (E2 = 0);
  ...
  function B2(d2, c2) {
    ...
    0 < A2 && (h = H2(-2, a, e2, e2, D2, z2, a.length, 0, 0, 0), h !== void 0 && (a = h));
    V2 = "";
    E2 = 0;
    z2 = D2 = 1;
    return a;
  ...
  for(var n2 = (t2.innerHTML || "").split("/*!sc*/\n"), r2 = [], o = 0, s = n2.length; o < s; o++) {
    ...
    if(i) {
      ...
      if(a) {
        ...
        c2 !== 0 && (z(u2, c2), F(e2, u2, a[3]), e2.getTag().insertRules(c2, r2)), r2.length = 0;
      } else
        r2.push(i);
    }
  }
...
function ce(e2) {
  var t2, n2, r2, o, s = e2 === void 0 ? E : e2, i = s.options, a = i === void 0 ? E : i, c2 = s.plugins, u2 = c2 === void 0 ? w : c2, l2 = new stylis_min(a), d2 = [], h = function(e3) {
    function t3(t4) {
      if(t4)
        try {
          e3(t4 + "}");
  ...
  var C2, I2 = new se(n2, g2, o ? e2.componentStyle : void 0), P2 = I2.isStatic && c2.length === 0, O2 = function(e3, t3) {
    return function(e4, t4, n3, r2) {
      ...
      var f3 = function(e5, t5, n4) {
        ...
        return i3;
      }(i2, r2, y2), w2 = n3, _2 = g3.$as || t4.$as || g3.as || t4.as || p3, N2 = xe(_2), A3 = g3 !== t4 ? v({}, t4, {}, g3) : t4, C3 = {};
      for(var I3 in A3)
        I3[0] !== "$" && I3 !== "as" && (I3 === "forwardedAs" ? C3.as = A3[I3] : (d3 ? d3(I3, index, _2) : !N2 || index(I3)) && (C3[I3] = A3[I3]));
      return t4.style && g3.style !== t4.style && (C3.style = v({}, t4.style, {}, g3.style)), C3.className = Array.prototype.concat(c3, h2, S3 !== h2 ? S3 : null, t4.className, g3.className).filter(Boolean).join(" "), C3.ref = w2, createElement(_2, C3);
    }(C2, e3, t3, P2);
  };
...
function We(e2) {
  for(var t2 = arguments.length, n2 = new Array(t2 > 1 ? t2 - 1 : 0), o = 1; o < t2; o++)
    n2[o - 1] = arguments[o];
  var i = Ce.apply(void 0, [e2].concat(n2)), a = "sc-global-" + ke(JSON.stringify(i)), u2 = new $e(i, a);
  function l2(e3) {
...
const ReactSearchBox = ({
  ...
  const handleInputChange = (e2) => {
    ...
    const matchedRecords2 = fuse.search(value2, {limit: 10});
    setValue(value2);
  ...
  const inputNode = () => {
    return /* @__PURE__ */ jsx(Input, {
      ...
      onKeyPress: onKeyPress ? onKeyPress : void 0,
      inputFontColor,
      inputBorderColor,
      inputFontSize,
      inputHeight,
